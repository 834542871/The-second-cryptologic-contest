...
//#define LONG  4096		//32*32分组需要的数据3968
#define LONG  16384		//64*64分组需要的数据
//#define LONG  65536		//128*128分组需要的数据
...
void ISD_SMS4Crypt(muint8 *Input, muint8 *Output, muint32 *rk)
{
...
{	
	...
	FILE *fp=NULL;
	if((fp=fopen("C://Users//Administrator//Desktop//密码竞赛//基于全息的音频图像保密认证系统//WaterData.txt","r"))==NULL)  //读取WaterData.txt的文件
	...
	//	n=n+16;
		...
		ISD_SMS4Crypt(mm,k,rk);
		//	printf("加密:");
		for(int i=0;i<16;i++)
		{
		
		//	printf(" %d",k[i]);
			fJ = fopen("C://Users//Administrator//Desktop//密码竞赛//基于全息的音频图像保密认证系统//JiaM.txt","a");
			fprintf(fJ,"%d ",k[i]);
			fclose(fJ);
...
////////////////////////////解密开始/////////////////////////////////////////////
		...
		//}
  //      printf(" 现在写入解密后文件 \n "); //从这里开始 
       	fR = fopen("C://Users//Administrator//Desktop//密码竞赛//基于全息的音频图像保密认证系统//VS.txt","a");
  	    fprintf(fR,"%s",o);
		fclose(fR);
 	}
	fclose(fp);
